...
public class simpleGoalBlueAuto extends OpMode {
    ...
    private final Pose shootPose = new Pose (34.56,108.69,Math.toRadians(136));
    private final Pose endPose = new Pose (34.74,135.11,90);
        ...
        switch(pathState){
            ...
            case SHOOT:
                ...
                if (opModeTimer.getElapsedTimeSeconds()>2){
                    ...
                    setPathState(SHOOTPOSETOENDPOSE);
                }
                break;
