...
public class genesisAuto extends OpMode {
    ...
    private final Pose endPose = new Pose (88.62,56,Math.toRadians(90));
    ...
    public void init(){
        ...
        turret = new Turret(hardwareMap, false,follower,false);
