...
//target 1150
    ...
    PathStateR pathState;
    private final Pose startPose = new Pose(119.000, 125.000, Math.toRadians (40));
    private final Pose shootPreloadPose = new Pose (99.887, 99.603,Math.toRadians(0));
    private final Pose startIntakeGPPPose = new Pose (93.648, 85.071,Math.toRadians(0));
    private final Pose endIntakeGPPPose = new Pose (120.816, 85.184,Math.toRadians(0));
    private final Pose startClear1 = new Pose (110, 75,Math.toRadians(0));
    private final Pose endClear1  = new Pose (125,76,Math.toRadians(0));
    private final Pose shootGPPPose = new Pose (98.64,97.98,Math.toRadians(0));
    private final Pose shootPPGstartIntakePGPcontrolPoint = new Pose (79.517,63.302,Math.toRadians(0));
    private final Pose startIntakePGPPose = new Pose (93.156,59.73,Math.toRadians(0));
    private final Pose endIntakePGPPose = new Pose (130.51,59.119,Math.toRadians(0));
    private final Pose shootPGPPose = new Pose (98.64,97.98,Math.toRadians(0));
    private final Pose startIntakePPG = new Pose (93.156,35.707, Math.toRadians(0));
    private final Pose endIntakePPG = new Pose (130.025,35.330, Math.toRadians(0));
    private final Pose shootPPG = new Pose (88.38,35.7,Math.toRadians(0));
    private final Pose end = new Pose (95.5,120.612,0);
    ...
    public void buildPaths(){
        ...
        startClear1_endClear1 = follower.pathBuilder().addPath(new BezierLine (startClear1, endClear1))
                ...
                .build();
        endClear1_shootPPG = follower.pathBuilder().addPath(new BezierCurve (endClear1,new Pose (119,75.8),shootPPG))
        ...
        endIntakePGP_shootPGP = follower.pathBuilder()
                .addPath(new BezierCurve (endIntakePGPPose, new Pose (102.83, 71.417), shootPGPPose))
        ...
        switch (pathState) {
            case START:
                ...
                if (!follower.isBusy() && turret.getFlywheelVelocity() > turret.getFlywheelVelocity() - 75) {
                    ...
                    setPathState(PathStateR.START_SHOOTPRELOAD);
            ...
            case START_SHOOTPRELOAD:
                ...
                if (!follower.isBusy()) {
                    ...
                    if (opModeTimer.getElapsedTimeSeconds() > 3) {
                        ...
                        setPathState(PathStateR.SHOOTPRELOAD_STARTINTAKEPPG);
                    }
                }
            ...
            case SHOOTPRELOAD_STARTINTAKEPPG:
                ...
                if (!follower.isBusy()){
                    ...
                    intake.setIntakePower(1);
                    setPathState(PathStateR.STARTINTAKEPPG_ENDINTAKEPPG);
            ...
            case STARTINTAKEPPG_ENDINTAKEPPG:
                ...
                if (!follower.isBusy()){
                    ...
                    setPathState(PathStateR.ENDINTAKEPPG_STARTCLEAR1);
            ...
            case ENDINTAKEPPG_STARTCLEAR1:
                ...
                if (!follower.isBusy()){
                    ...
                    setPathState(PathStateR.STARTCLEAR1_ENDCLEAR1);
            ...
            case STARTCLEAR1_ENDCLEAR1:
                ...
                if (!follower.isBusy()&& opModeTimer.getElapsedTimeSeconds()>2){
                    ...
                    setPathState(PathStateR.ENDCLEAR1_SHOOTPPG);
                    follower.setMaxPower(1);
            ...
            case ENDCLEAR1_SHOOTPPG:
                ...
                if (!follower.isBusy()){
                    ...
                    setPathState(PathStateR.SHOOTPPG);
            ...
            case SHOOTPPG:
                ...
                if (opModeTimer.getElapsedTimeSeconds()>3.5) {
                    ...
                    setPathState(PathStateR.SHOOTPPG_STARTINTAKEPGP);
            ...
            case SHOOTPPG_STARTINTAKEPGP:
                ...
                if (!follower.isBusy()){
                    ...
                    setPathState(PathStateR.STARTINTAKEPGP_ENDINTAKEPGP);
                }
                break;
            case STARTINTAKEPGP_ENDINTAKEPGP:
                ...
                if (!follower.isBusy()){
                    ...
                    setPathState(PathStateR.ENDINTAKEPGP_SHOOTPGP);
            ...
            case ENDINTAKEPGP_SHOOTPGP:
                ...
                if (!follower.isBusy()){
                    ...
                    spindex.startRotate(1);
                        ...
                        setPathState(PathStateR.SHOOTPGP);
            ...
            case SHOOTPGP:
                ...
                if (opModeTimer.getElapsedTimeSeconds()>3.5) {
                    ...
                    setPathState(PathStateR.SHOOTPGP_STARTINTAKEGPP);
            ...
            case SHOOTPGP_STARTINTAKEGPP:
                ...
                if (!follower.isBusy()){
                    ...
                    setPathState(PathStateR.STARTINTAKEGPP_ENDINTAKEGPP);
                }
                break;
            case STARTINTAKEGPP_ENDINTAKEGPP:
                ...
                if (!follower.isBusy()){
                    ...
                    spindex.startRotate(1);
                    setPathState(PathStateR.ENDINTAKEGPP_SHOOTGPP);
                }
                break;
            ...
            case SHOOTGPP:
                ...
                if (opModeTimer.getElapsedTimeSeconds()>3.5) {
                    ...
                    setPathState(PathStateR.SHOOTGPP_END);
    ...
    public void setPathState(PathStateR newState){
        pathState=newState;
