...
@Config
@TeleOp(name="Genesis Drive")
public class genesisDrive extends OpMode {
    ...
    public static Pose startingPose =new Pose (88.62,56,Math.toRadians(90));//56,8,90
    ...
    public void init(){
        ...
        turret = new Turret(hardwareMap, "red",follower,false);
